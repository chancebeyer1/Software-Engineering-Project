...
{
	/*
	 * The client will need the server's IP address. Here is how you find it for
	 * your system.
	 * 
	 ...
	 * 
	 * MacOS From System preferences Network category, read the IP address directly
	 * 
	 */
	...
	/**
	 * list of active client threads by ID number Vector is a "thread safe"
	 * ArrayList
	 */
	...
	public void addLoggedInUsers(String user)
	{
		try
		{
	...
	public void removeLoggedInUsers(String user)
	{

		loggedInUsers.remove(user);
		System.out.println("SERVER: logout successful for user " + user + "\n");
	...
	/**
	 * constructor creates the list of clients and starts the server listening on
	 * the port
	 */
	public Server()
	{
	...
	/**
	 * listen for incoming client connections analogous to a telephone operator
	 * listens for the phone to ring routes the incoming call to the requested
	 * extension goes back to listening for the phone to ring
	 * 
	...
	public void run()
	{
		...
		try
		{
			...
			while (running)
			{
				...
				// between the server (thread) and client (route the call to the requested
				// extension)
	...
	/**
	 * called by a ServerThread when a client is terminated to remove the connection
	 * from the list
	 * 
